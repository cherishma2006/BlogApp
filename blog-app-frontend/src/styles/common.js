...
export const pageBackground =
  "bg-gradient-to-br from-pink-50 via-orange-50 to-sky-50 min-h-screen";
...
export const pageTitleClass =
  "text-5xl font-bold text-gray-800 tracking-tight leading-none mb-2";

export const headingClass =
  "text-2xl font-bold text-gray-800 tracking-tight";

export const subHeadingClass =
  "text-lg font-semibold text-gray-700 tracking-tight";
...
export const linkClass =
  "text-pink-500 hover:text-orange-400 transition-colors";

// ─── Buttons ──────────────────────────────────────────
export const primaryBtn =
  "bg-gradient-to-r from-pink-300 via-orange-200 to-sky-200 text-gray-700 font-semibold px-5 py-2 rounded-full hover:scale-105 transition-all duration-300 shadow-md text-sm tracking-tight";

export const secondaryBtn =
  "border border-pink-100 bg-white/70 text-gray-700 font-medium px-5 py-2 rounded-full hover:bg-pink-50 transition-all cursor-pointer text-sm";

export const ghostBtn =
  "text-pink-500 font-medium hover:text-orange-400 transition-colors text-sm";
